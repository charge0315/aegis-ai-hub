...
export class ScraperFacade {
    /**
     * @param {string} interestsPath - 興味設定ファイルのパス
     * @param {string} feedsPath - フィード構成ファイルのパス
     */
     ...
     * @returns {Promise<Array>} 厳選された記事リスト
     */
     ...
     * @param {Object} interests - ユーザーの興味データ
     * @returns {Promise<Object>} カテゴリ別に分類された記事データ
     */
     ...
     * @param {Object} interests - ユーザーの興味データ
     * @returns {Promise<Array<Article>>} 正規化された記事オブジェクトの配列
     * @private
     */
