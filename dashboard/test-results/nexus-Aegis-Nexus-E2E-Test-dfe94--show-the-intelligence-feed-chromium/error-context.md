...
- Name: nexus.test.ts >> Aegis Nexus E2E Tests >> should load the dashboard and show the intelligence feed
- Location: tests\e2e\nexus.test.ts:9:3
...
Locator: getByRole('heading', { name: 'Intelligence Feed' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Intelligence Feed' })
