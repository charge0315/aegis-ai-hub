...
- Name: nexus.test.ts >> Aegis Nexus E2E Tests >> should trigger command palette with Ctrl+K
- Location: tests\e2e\nexus.test.ts:43:3
...
Call log:
  ...
  - waiting for getByTestId('command-palette')
...
- generic [ref=e3]:
  - complementary [ref=e4]:
    ...
    - navigation [ref=e10]:
      ...
      - button "Nexus Command" [ref=e20]:
        - img [ref=e22]
        - generic [ref=e25]: Nexus Command
    - generic [ref=e27]:
